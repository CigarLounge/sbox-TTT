	...
	public class Effect : Panel
	{
		public IItem Item
		{
			...
			private set
			{
				...
				_nameLabel.Text = _item?.GetItemData().LibraryTitle ?? "";
				_effectImage.Texture = _item != null ? Texture.Load( FileSystem.Mounted, $"/ui/icons/{_item.GetItemData().LibraryTitle}.png", false ) : null;
