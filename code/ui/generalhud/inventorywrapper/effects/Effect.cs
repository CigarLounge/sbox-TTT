	...
	public class Effect : Panel
	{
		public IItem Item
		{
			...
			private set
			{
				...
				_nameLabel.Text = _item?.GetLibraryData().Title ?? "";
				_effectImage.Texture = _item != null ? Texture.Load( FileSystem.Mounted, $"/ui/icons/{_item.GetLibraryData().Title}.png", false ) : null;
